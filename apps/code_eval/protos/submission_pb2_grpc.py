...
class SubmissionServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetSubmissionResource = channel.unary_unary(
                ...
                _registered_method=True)
        self.GetSubmissionFolderStructure = channel.unary_unary(
                '/submission.SubmissionService/GetSubmissionFolderStructure',
                request_serializer=submission__pb2.SubmissionResourceRequest.SerializeToString,
                response_deserializer=submission__pb2.SubmissionFolderStructureResponse.FromString,
                _registered_method=True)
...
class SubmissionServiceServicer(object):
    ...
    def GetSubmissionFolderStructure(self, request, context):
        """Get submission folder structure via submission id,
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_SubmissionServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetSubmissionFolderStructure': grpc.unary_unary_rpc_method_handler(
                    servicer.GetSubmissionFolderStructure,
                    request_deserializer=submission__pb2.SubmissionResourceRequest.FromString,
                    response_serializer=submission__pb2.SubmissionFolderStructureResponse.SerializeToString,
            ),
    }
...
class SubmissionService(object):
    ...
    @staticmethod
    def GetSubmissionResource(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
    ...
    @staticmethod
    def GetSubmissionFolderStructure(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/submission.SubmissionService/GetSubmissionFolderStructure',
            submission__pb2.SubmissionResourceRequest.SerializeToString,
            submission__pb2.SubmissionFolderStructureResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
